...
// /___/   /\     Timestamp : 02/04/2026 15:06:11
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/test_sch/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_6 (.A(XLXN_27[7:0]), 
                                  .B(XLXN_19[7:0]), 
                                  .EQ(XLXN_34));
   ...
   FD8CE_MXILINX_dropfifo XLXI_13 (.C(clk), 
                                   .CE(XLXN_42), 
                                   .CLR(rst), 
                                   .D(XLXN_27[7:0]), 
                                   .Q(XLXN_26[7:0]));
   // synthesis attribute HU_SET of XLXI_13 is "XLXI_13_17"
   OR2 XLXI_16 (.I0(XLXN_13), 
                .I1(XLXN_14), 
                .O(XLXN_15));
   AND2B1 XLXI_17 (.I0(XLXN_25), 
                   .I1(XLXN_15), 
                   .O(XLXN_42));
   CB8CLE_MXILINX_dropfifo XLXI_18 (.C(clk), 
                                    .CE(XLXN_43[0]), 
                                    .CLR(rst), 
                                    .D(XLXN_26[7:0]), 
                                    .L(XLXN_25), 
   ...
   CB8CE_MXILINX_dropfifo XLXI_22 (.C(clk), 
                                   .CE(XLXN_40), 
                                   .CLR(rst), 
                                   .CEO(), 
                                   .Q(XLXN_19[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_22 is "XLXI_22_21"
   FDC XLXI_23 (.C(clk), 
                .CLR(rst), 
                .D(XLXN_40), 
                .Q(valid_data));
   defparam XLXI_23.INIT = 1'b0;
   AND3B2 XLXI_24 (.I0(XLXN_30), 
                   .I1(XLXN_34), 
                   .I2(fiforead), 
                   .O(XLXN_40));
   reg9B XLXI_25 (.ce(XLXN_53), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_54[71:0]));
   VCC XLXI_29 (.P(XLXN_53));
   mem XLXI_31 (.addra(XLXN_27[7:0]), 
                .addrb(XLXN_19[7:0]), 
                .clka(clk), 
                .clkb(clk), 
                .dina(XLXN_54[71:0]), 
